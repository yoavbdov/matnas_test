    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" dir="rtl">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl max-w-xl w-full max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <h2 className="text-base font-semibold text-gray-800">ייבוא תחרויות מ-CSV</h2>
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-5">
          <div>
            ...
            <p className="text-xs text-gray-400 mb-2">עמודות עם <span className="text-red-400 font-bold">*</span> הן חובה. סיבובים ומשתתפים יש להוסיף ידנית לאחר הייבוא.</p>
        ...
        <div className="px-6 py-4 border-t border-gray-100 flex justify-end gap-2">
          ...
          <Btn onClick={handleImport} loading={saving} disabled={validCount === 0 || errorCount > 0}>
            ייבא {validCount > 0 ? `${validCount} תחרויות` : ""}
          </Btn>
        </div>
      </div>
    </div>
